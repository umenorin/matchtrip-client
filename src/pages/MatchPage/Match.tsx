...
import MatchActions from "../../components/MatchActions/MatchActions";
...
export default function Match() {
  ...
  const members = [
    { name: "Ruan Costa", avatar: "https://randomuser.me/api/portraits/men/32.jpg" },
    { name: "Estela Paula", avatar: "https://randomuser.me/api/portraits/women/44.jpg" },
    { name: "Estela Paula", avatar: "https://randomuser.me/api/portraits/women/45.jpg" },
  ];
